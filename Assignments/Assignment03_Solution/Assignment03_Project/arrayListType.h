...
Modifying the existing code to implement these functions
isEmpty()
isFull()
listSize()
maxListSize()
...
bool arrayListType<elemType>::isEmpty() const
{
	if (list == 0)
	{
		...
		cout << endl;
		cout << "The list contains at least one or more strings" << endl;
...
bool arrayListType<elemType>::isFull() const
{
	if (length >= maxSize)
	{
		...
		cout << "The list is not full yet." << endl;
...
void arrayListType<elemType>::clearList()
{
	...
	cout << "The size of the list is now ";
	listSize();
	cout << endl;
} //end clearList
